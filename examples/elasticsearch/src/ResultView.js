  ...
  <div className="mt-4">
    ...
    <div className="bg-white p-1 w-80 hover:shadow-2xl max-w-3xl sm:w-full sm:p-4 h-auto sm:h-64 rounded-2xl shadow-lg  flex flex-col sm:flex-row gap-5 select-none flex justify-center items-center border bg-gray-100">
      ...
      <div className="bg-white relative shadow-lg hover:shadow-xl transition duration-500 rounded-lg">
        ...
        <div className="absolute top-2 right-2 py-2 px-1 bg-white rounded-xl text-xs">
          <span className="text-md">{result.type.raw}</span>
        </div>
      </div>
      ...
      <div className="flex sm:flex-1 flex-col gap-8 p-1 ">
        ...
        <p className="text-gray-500 text-sm sm:text-base line-clamp-3  ">
          <p className="overflow-ellipsis overflow-hidden flex-grow-0 h-20 text-sm"> {result.description.raw}</p>
        </p>
        <div className="flex gap-4 mt-auto">
          <button
            className='bg-indigo-100 hover:bg-green-500 flex items-center gap-1 sm:text-lg border border-gray-300 px-3 py-1 rounded-full   transition-colors '
          >
            ...
            <span className="text-xs">556</span>
          </button>
          <button
            className=' bg-indigo-100 hover:bg-green-500 flex items-center gap-1 sm:text-lg border border-gray-300 px-3 py-1 rounded-full   transition-colors '
          >
            ...
            <span className="text-xs"> نظرات-56</span>
          </button>
          <button
            className='bg-indigo-100 hover:bg-green-500 ml-auto flex items-center gap-1 sm:text-lg border border-gray-300 px-3 py-1 rounded-full   transition-colors '
          >
