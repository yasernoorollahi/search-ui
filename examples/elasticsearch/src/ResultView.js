    ...
    <div className="bg-white p-1 w-80 hover:shadow-2xl max-w-3xl sm:w-full sm:p-4 h-auto sm:h-64 rounded-2xl shadow-lg  flex flex-col sm:flex-row gap-5 select-none flex justify-center items-center border bg-gray-100">
      ...
      <div className="flex sm:flex-1 flex-col gap-8 p-1 ">
        ...
        <div className="flex gap-4 mt-auto">
          <button
            className='bg-indigo-100 hover:bg-blue-500 flex items-center gap-1 sm:text-lg border border-gray-300 px-3 py-1 rounded-full   transition-colors '
          >
          ...
          >
            ...
            <span className="text-xs"> Comments-56</span>
          </button>
          <button
            className='bg-indigo-100 hover:bg-blue-500 ml-auto flex items-center gap-1 sm:text-lg border border-gray-300 px-3 py-1 rounded-full   transition-colors '
          >
